/**
 * Écran de création de facture - étape finale
 */
...
const CreateInvoiceScreen: React.FC<Props> = ({ navigation, route }) => {
  ...
  const handleCreateInvoice = async () => {
    ...
    try {
      ...
      const response = await documentsAPI.invoices.create(invoiceData);
          ...
          [
            {
              text: 'OK',
              onPress: () => {
                // Retourner à l'écran de liste des factures
                navigation.navigate('Main', {
                  screen: 'DocumentsTab',
                });
                // Puis naviguer vers l'écran Invoices
